...
Thin adapter between Dendrite's universal types and the OpenAI Chat Completions API.
...
class OpenAIProvider(LLMProvider):
    ...
    # ------------------------------------------------------------------
    # Outbound conversions: Dendrite → OpenAI
    # ------------------------------------------------------------------

    def _convert_messages(self, messages: list[Message]) -> list[dict[str, Any]]:
        """Convert Dendrite messages to OpenAI Chat Completions format.
    ...
    def _convert_tools(self, tools: list[ToolDef]) -> list[dict[str, Any]]:
        """Convert Dendrite ToolDefs to OpenAI function tool format."""
        return [
            {
                "type": "function",
                "function": {
    ...
    # ------------------------------------------------------------------
    # Inbound conversions: OpenAI → Dendrite
    # ------------------------------------------------------------------

    def _normalize_response(self, response: Any) -> LLMResponse:
        """Convert OpenAI ChatCompletion to Dendrite LLMResponse."""
