"""Streaming with OpenAI Responses API — tool calls via gpt-4o-mini.

The Responses API is OpenAI-specific (no compatible backends) but supports
built-in tools like web_search_preview alongside custom Dendrux tools.

Run with:
    OPENAI_API_KEY=sk-... python examples/08_streaming_openai_responses.py
"""
